window.addEventListener('load', function() {
    ...
    // my code try to use addevent
    //var ele = document.getElementById('content');
    //var y = ele.scrollHeight;
    /* var ss= list1.getElementsByClassName('s navbar__list');
     var se1 = document.getElementsByClassName('s1 navbar__list')[0];
     var se2 = document.getElementsByClassName('s2 navbar__list')[0];
     var se3 = document.getElementsByClassName('s3 navbar__list')[0];
     var se4 = document.getElementsByClassName('s4 navbar__list')[0];
     se4.addEventListener("click", function() {
         //sec4.innerHTML.className = "active";
         se4.className = "active";

     });*/



    // new try with intersecion observer
